...
import { loadingBar, isAlert } from "../state/Action-creator";
import { useDispatch } from "react-redux";

export default function Adminsignupmodal(props) {
  ...
  const handlesubmit = async (e) => {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_LOCAL}/auth/authenticate`,
      {
        method: "POST",
        headers: {
    ...
    if (json.success) {
      ...
      dispatch(isAlert(true, "Mail has been sent to admin","green"));
      setTimeout(() => {
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      >
                        Authenticate you identity
                      </Dialog.Title>
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          We will send you a varification link on your mail to
